...
Migrated from gnssvodpy.utils.date_time
"""
...
class YYYYDOY:
    ...
    def _calculate_date(self) -> datetime.date:
        ...
        return datetime.date(self.year, 1, 1) + datetime.timedelta(days=int(self.doy) - 1)
    ...
    def _gpsweekday(self) -> tuple[int, int]:
        ...
        GPS time starts 1980-01-06.

        Returns
        -------
        tuple[int, int]
            (GPS week number, day of week 0-6)
